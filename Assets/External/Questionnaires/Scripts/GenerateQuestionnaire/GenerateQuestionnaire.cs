...
namespace VRQuestionnaireToolkit
{
    public class GenerateQuestionnaire : MonoBehaviour
    {
        ...
        private void FireEvent()
        {
            ...
            // TODO improve From -To page collection when pages are not gameobjects but components
            questionnaireController.OnQuestionnaireEnd?.Invoke(new QuestionnaireNavigationEventArgs { From = _pageFactory.PageList[_pageFactory.CurrentPage] });
        }
            ...
            */
            while (true)
            {
                ...
                if (pId != "")
                {
                    ...
                    _pageFactory.AddPage(qId, qType, qInstructions, _qData, _qConditions, _qOptions, pId);
                    i++;
                }
                else
                {
                    ...
                    Debug.Log("Questionnaire begin");
                    // TODO Improve
                    questionnaireController.OnQuestionnaireBegin?.Invoke(new QuestionnaireNavigationEventArgs { To = _pageFactory.PageList[_pageFactory.CurrentPage] });
