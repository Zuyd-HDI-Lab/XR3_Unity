    ...
    public class Trial : IExperimentUnit, IDataAssociatable
    {
        ...
        public void Begin()
        {
            ...
            result = new ResultsDictionary(session.Headers, true)
            {
                ...
                ["trial_num_in_block"] = numberInBlock,
        ...
        {
            if (!session.TrackObjectsOnSessionLevel)
            {
                ...
                if (duplicateTrackers.Any())
                    throw new InvalidOperationException(string.Format(
                        "Two or more trackers in the Tracked Objects field in the Session Inspector have the following object name and descriptor pair, please change the object name fields on the trackers to make them unique: {0}",
