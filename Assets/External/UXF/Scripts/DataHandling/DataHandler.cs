...
# endif
    ...
    {
        TrialResults, SessionLog, Settings, ParticipantDetails, Trackers, SummaryStatistics, OtherTrialData, OtherSessionData, SessionTrackers
    }
    ...
    public static class DataHandlerEnumExtensions
    {
        ...
        static Dictionary<UXFDataType, UXFDataLevel> typeLevelMapping = new Dictionary<UXFDataType, UXFDataLevel>
        {
            ...
            { UXFDataType.SessionTrackers, UXFDataLevel.PerSession }
        };
